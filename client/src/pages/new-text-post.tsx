  ...
  return (
    <div className="flex flex-col h-screen bg-white max-w-md mx-auto">
      ...
      <div className="flex-1 overflow-auto">
        ...
        {/* Poll Button */}
        <div className="px-4 py-3 border-b">
          <button className="flex items-center gap-2 rounded-full py-2 px-4 bg-gray-50 w-full">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b">
          ...
          <div className="flex items-center">
            <span className="text-gray-500 mr-1">Everyone</span>
            <ChevronRight size={20} />
          </div>
        </div>
        ...
        <div className="border-b">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="transform rotate-180">
          ...
          <div className="flex justify-between items-center px-4 py-2 border-b">
            ...
            <button className="bg-transparent border border-gray-300 rounded px-2 py-1 text-xs">
              Connect
            </button>
          </div>
        ...
        {/* Extra padding to ensure content is visible when fixed button is at bottom */}
        <div className="pb-20"></div>
      </div>
      
      {/* Share Button - Fixed at bottom */}
      <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto border-t bg-white p-4">
        <button
