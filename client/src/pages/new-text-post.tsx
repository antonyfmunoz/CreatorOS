        ...
        <div className="divide-y border-t border-b">
          ...
          <div>
            <div className="flex items-center justify-between px-4 py-3 cursor-pointer" onClick={() => setIsPostToExpanded(!isPostToExpanded)}>
              ...
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`transform transition-transform ${isPostToExpanded ? 'rotate-180' : ''}`}>
