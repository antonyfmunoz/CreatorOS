    ...
    <div className="flex flex-col h-screen bg-white max-w-md mx-auto">
      ...
      <div className="flex-1 overflow-y-auto pb-16">
        ...
        <div className="px-4 py-3 border-b">
          <button className="flex items-center gap-2 w-full rounded-full bg-gray-50 py-2.5 px-4">
        ...
        <div className="border-b">
          ...
          <div className="flex justify-between items-center px-4 py-2.5">
            ...
            <button className="px-3 py-1 text-xs font-medium rounded-full border border-gray-200">
              Connect
            </button>
          </div>
      ...
      {/* Share Button */}
      <div className="fixed bottom-0 w-full max-w-md px-4 py-2 bg-white border-t">
        <button
          className="w-full bg-black text-white py-2.5 rounded-md font-semibold text-sm"
