...
export default function MessagesPage() {
  ...
  useEffect(() => {
    if (selectionDismissed || isMobile) return;
  ...
  }, [filteredConversations, selectedId, selectionDismissed, isMobile]);
      ...
      <section className={`${selectedId ? "flex" : "hidden md:flex"} min-w-0 flex-1 flex-col`}>
        {detail.data ? <>
          <header className="flex h-16 items-center gap-3 border-b border-zinc-900 px-4">
            <Button aria-label="Back to conversations" variant="ghost" size="icon" className="md:hidden" onClick={() => { setSelectionDismissed(true); setSelectedId(null); }}><ArrowLeft className="h-5 w-5" /></Button>
