import { ArrowLeft, BookOpen, Bot, CalendarPlus, FileText, Film, Image, LayoutDashboard, Megaphone, Mic, PackagePlus, Radio, Repeat2, Send, Sparkles, Video } from "lucide-react";
