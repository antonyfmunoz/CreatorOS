...
export default function MediaLibraryPage() {
  ...
  async function openAsset(asset: MediaAsset) {
    ...
    try { const access = await (await apiRequest("GET", `/api/assets/${asset.id}/access`)).json(); setPreviewUrl(access.url); }
