...
export default function CutStudioPage() {
  ...
  const render = async (clip?: { start: number; end: number }) => { await startJob("render", { aspect, captions, captionStyle, cleanAudio, audioPreset, masterGainDb, quality, audioBitrateKbps, resolution, fps, clip }); };
