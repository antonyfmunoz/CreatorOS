    ...
    <main className="min-h-screen bg-black pb-24 text-white">
      ...
      <div className="mx-auto grid max-w-[1500px] gap-4 p-3 lg:grid-cols-[1fr_360px]">
        <section className="min-w-0 space-y-4">
          ...
          <div className="relative flex min-h-[280px] items-center justify-center overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950" aria-label="Timeline monitor" data-rendered-timeline-provenance={timelineMonitorMode === "rendered" ? renderedTimelineProvenance : undefined}>
