...
describe("application chrome routing", () => {
  ...
  it.each(["/trust", "/legal/data-deletion", "/communities/8/rooms/room-1", "/search", "/broadcast/control/00000000-0000-4000-8000-000000000001", "/broadcast/field", "/ugc/creator/42"])(
