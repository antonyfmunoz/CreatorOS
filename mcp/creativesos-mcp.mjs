...
const tools = [
  ...
  ["creativesos_cut_projects", "List CutStudio projects for the API key's scoped business. This returns project metadata only; it cannot read source media, edit a timeline, pair a node, or execute a render.", "/cut/projects"],
