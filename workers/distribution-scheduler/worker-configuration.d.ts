/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/distribution-scheduler/wrangler.jsonc workers/distribution-scheduler/worker-configuration.d.ts` (hash: f626f80a9f91a2ce409d0b28b5f32871)
// Runtime types generated with workerd@1.20260820.1 2026-08-12 nodejs_compat
interface __BaseEnv_Env {
	API_BASE_URL: "https://creativesos.net";
	DISTRIBUTION_DISPATCH_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_BASE_URL" | "DISTRIBUTION_DISPATCH_SECRET">> {}
}
