...
try {
  ...
  $required = @("users", "businesses", "posts", "products", "communities", "orders", "automation_definitions", "relationships", "account_privacy_requests", "production_backups", "broadcast_studios", "broadcast_studio_collaborators", "broadcast_brand_kits", "broadcast_template_catalog", "broadcast_destinations", "broadcast_sessions", "broadcast_session_tracks", "broadcast_audience_messages")
