...
try {
  ...
  const requiredArchiveTables = ["users", "posts", "orders", "production_backups", "cut_studio_audio_templates", "broadcast_studios", "broadcast_template_catalog", "broadcast_destinations", "broadcast_sessions", "broadcast_audience_messages"];
