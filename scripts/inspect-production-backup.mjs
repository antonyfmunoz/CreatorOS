...
try {
  ...
  const requiredArchiveTables = ["users", "posts", "orders", "production_backups", "broadcast_studios", "broadcast_destinations", "broadcast_sessions", "broadcast_audience_messages"];
