...
import { qualifyCutDispatchBudget } from "./qualify-cut-dispatch-budget";
...
let dispatchReceipt: Awaited<ReturnType<typeof qualifyCutDispatchBudget>> | undefined;
...
try {
  ...
  publicationReceipt = await qualifyCutJobPublication(project);
  ...
  dispatchReceipt = await qualifyCutDispatchBudget(project);
