...
const requiredColumns = {
  ...
  cut_studio_jobs: ["worker_id", "worker_region", "lease_token", "lease_expires_at", "heartbeat_at", "cancellation_requested_at", "attempt", "max_attempts", "retry_of_job_id", "dispatch_attempt", "max_dispatch_attempts", "dispatch_token", "dispatch_expires_at"],
