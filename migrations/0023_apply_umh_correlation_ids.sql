-- Repair migration: production's ledger already contained the timestamp that
-- had briefly been used for 0022. Keep every statement idempotent so both an
-- existing deployment and a clean installation reach the same schema.
