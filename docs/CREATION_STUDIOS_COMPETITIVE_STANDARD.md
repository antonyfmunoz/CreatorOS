...
| Brand production | Lower thirds, tickers, countdowns, asset logos, persistent color kit and adjustable fade/slide/pulse overlay motion | Reusable team-level brand kits and expanded motion presets | Product code |
