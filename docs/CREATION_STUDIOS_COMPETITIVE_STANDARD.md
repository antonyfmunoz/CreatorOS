...
| Source control | Transform, crop, layer, blend, basic visual filters, mute/volume, reusable render-effective source presets, high/low-pass audio filters, dynamics compression and local monitoring | Chroma key, LUT, audio noise suppression and advanced routing | Product code; device limitations apply |
