...
| Source control | Transform, crop, layer, blend, basic filters, mute/volume and reusable render-effective source presets | Chroma key, LUT, audio filters and monitoring | Product code; device limitations apply |
