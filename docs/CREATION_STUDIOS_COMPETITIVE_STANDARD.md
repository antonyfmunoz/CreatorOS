...
| Review/collaboration | Immutable versions, hashed expiring/revocable review links, private playback, time-coded comments, change requests, approvals, owner resolution, and owner-scoped synchronized side-by-side version comparison implemented | Add workspace collaborators and mention notifications | Product code |
