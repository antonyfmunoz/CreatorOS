...
| Multitrack edit | Private project media library plus real B-roll/PIP, audio beds, synchronized clip grouping, durable named compounds, and timed native title/lower-third/callout graphics rendered by FFmpeg | Richer per-track locks, visibility, mute/solo and shared bus controls | Product code |
