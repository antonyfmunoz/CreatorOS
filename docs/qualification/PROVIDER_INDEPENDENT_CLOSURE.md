...
- Unit, typecheck, production build, bundle budget and Worker dry-deployment
  gates pass.
- The complete authenticated browser matrix schedules 204 executions on
  disposable 109-migration databases across mobile and desktop: 198 pass, six
  are intentional skips, and none fail. It includes media, offline recovery,
  activation, data-portability and provider-preflight lifecycles.
