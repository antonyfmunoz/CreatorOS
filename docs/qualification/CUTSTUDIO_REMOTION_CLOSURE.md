...
| Encoding | H.264 MP4, alpha VP9 WebM, PNG/JPEG/WebP stills, image sequences, frame ranges and receipts | Additional codecs/containers, encoding controls, GIF/ProRes/HDR where supported and benchmarked |
