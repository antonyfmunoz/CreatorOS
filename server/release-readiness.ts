...
export function getReleaseReadiness(
  ...
  return {
    ...
    cutStudio: {
      ...
      broadcastMulticamIngest: "configured",
      renderEffectiveAngleSwitching: "configured",
      originalSafeEditingProxies: "configured",
    ...
    broadcastStudio: {
      ...
      liveSceneMultiview: "configured",
      operatorTransitionSet: "configured",
      authenticatedPhoneController: "configured",
      ...
      destinationSpecificFraming: "configured",
      ...
      secureCaptureNodePairing: "configured",
      captureNodeFleetControl: "configured",
      replayProtectedFieldTelemetry: "configured",
      adaptiveFieldEncodingDirectives: "configured",
      disconnectSlateContract: "configured",
      bondedLinkAwareness: "configured",
      deviceBatteryThermalStorageHealth: "configured",
      remoteCaptureConfiguration: "configured",
      productionMarkers: "configured",
      nativeAudienceControl: "configured",
      providerNeutralAudienceWidgets: "configured",
      nativeGoalsAndTipWidgets: "configured",
