...
export function securityHeaders(_req: Request, res: Response, next: NextFunction) {
  ...
  res.setHeader("Content-Security-Policy", [
    ...
    "frame-src 'self' https://accounts.creativesos.net https://clerk.creativesos.net https://*.clerk.com https://*.clerk.accounts.dev https://challenges.cloudflare.com https://checkout.stripe.com https://www.facebook.com https://web.facebook.com",
