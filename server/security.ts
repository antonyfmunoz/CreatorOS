...
export function securityHeaders(_req: Request, res: Response, next: NextFunction) {
  ...
  res.setHeader("Content-Security-Policy", [
    ...
    `script-src 'self'${isProduction ? "" : " 'unsafe-inline'"} https://clerk.creativesos.net https://*.clerk.com https://*.clerk.accounts.dev https://challenges.cloudflare.com`,
    "style-src 'self' 'unsafe-inline'",
    "img-src 'self' data: blob: https:",
    "media-src 'self' blob: https:",
    "font-src 'self' data:",
    "connect-src 'self' https: wss:",
    "frame-src 'self' https://accounts.creativesos.net https://clerk.creativesos.net https://*.clerk.com https://*.clerk.accounts.dev https://challenges.cloudflare.com https://checkout.stripe.com",
