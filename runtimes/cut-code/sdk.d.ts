...
declare module '@creativesos/cut' {
  ...
  /** Pinned Three core rendered through the approved deterministic SVG bridge; not WebGPU or arbitrary addon support. */
  ...
  /** Pinned Three core rendered through the isolated SwiftShader WebGL bridge; no host GPU, WebGPU, network, or arbitrary addons. */
  export function WebGLScene(props: HTMLAttributes<HTMLDivElement> & { scene: Scene; camera: Camera; width?: number; height?: number }): ReactNode;
