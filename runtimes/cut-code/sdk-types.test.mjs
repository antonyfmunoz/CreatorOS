...
test('typechecks a native animated composition and its private asset imports', () => {
  check(`import {FullFrame,Sequence,Freeze,Repeat,FrameVideo,useFrame,useGlobalFrame,useComposition,useInputs,interpolate,spring,easing,cubicBezier,seededRandom,interpolateColor} from '@creativesos/cut';
...
const position=spring({frame,fps,stiffness:80,clampOvershoot:true});const color=interpolateColor(global,[0,30],['#000000','#ffffff']);
